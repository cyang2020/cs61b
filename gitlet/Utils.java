...
public class Utils {
     ...
     *  @param otherFiles otherFiles.
     *  @param otherMod otherMod.
     *  @param currBranch currBranch.
     *  @param currentFiles currentFiles.
     *  @param currentMod currentMod.
     *  @param givenBranch givenBranch.
     *  @param splitBranch splitBranch.
     *  @return a boolean.
     */
    public static boolean writeToFiles(boolean conflict
        ...
        for (String filename : currentMod) {
            if ((otherMod.contains(filename)
                    ...
                    .equals(currentFiles.get(filename)))
                ...
                File currFile
                        = new
                        File(Main.gitlet.workingDir
                        , ".gitlet/" + curFile);
                String midDiv = "=======\n";
                File givenFile
                        =
                        new File(Main.gitlet.workingDir
                                , ".gitlet/" + givFile);
                String btmDiv = ">>>>>>>\n";
                String x = "";
                if (currFile.exists()) {
                ...
                File outp = new File(Main.gitlet.workingDir, filename);
    ...
    static String readContentsAsString(File file) {
        ...
        return new String(readContents(file)
