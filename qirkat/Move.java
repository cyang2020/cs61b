...
class Move {
    ...
    /** @param move
     * A factory method that copies a move. */
    public Move(Move move) {
        this._fromIndex = move._fromIndex;
        this._nextJump = move._nextJump;
        this._toIndex = move._toIndex;
        this._col0 = move._col0;
        this._col1 = move._col1;
        this._row0 = move._row0;
        this._row1 = move._row1;
        this._isJump = move._isJump;
    }
    ...
    static Move move(Move move0, Move move1) {
        ...
        if (move0.isVestigial()) {
            ...
            if (move1.isVestigial()) {
                finalMove.set(move0.col0(), move0.row0(),
                        move1.col1(), move1.row1(), null);
            } else {
                finalMove.set(move0.col0(), move0.row0(),
        ...
        if (move0.jumpTail() == null) {
            Move result = move0;
            result._nextJump = move1;
            return result;
        } else {
            Move intermediate = move0;
            Move result = move0;
            while (intermediate._nextJump != null) {
                intermediate = intermediate._nextJump;
            }
            intermediate._nextJump = move1;
            return result;
        }
    }
     ...
     *  the left. */
    boolean isLeftMove() {
        return _col0 - 1 == _col1 && _row0 == _row1 && _nextJump == null;
    }
    ...
    /** Return true iff this is a side-way, non-capturing move. */
    boolean isSideWayMove() {
        return _col0 != _col1 && _row0 != _row1
                && index(_col0, _row0) % 2 == 0 && index(_col1, _row1) % 2 == 1;
    }
     ...
     * @return a string.
     * @param move */
    private String toStringHelper(Move move) {
        String save = "";
        save += "-";
        save += move.col1();
        save += move.row1();
